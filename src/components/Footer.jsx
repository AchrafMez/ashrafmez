...
function Footer() {
	return (
		<div className="py-8 text-center mt-10">
			<div className="container max-w-screen-lg mx-auto">
				<div>
					<div className="flex flex-wrap justify-center gap-3 mb-5">
						...
						<a 
							href="mailto:ashrafmeziouni@gmail.com"
							target="_blank"
							className="bg-stone-900 dark:bg-white p-2 text-white dark:text-stone-900 inline-flex items-center rounded-md hover:opacity-80 transition-opacity">
							<svg
								className="w-6 h-6"
						...
						<a 
							href="https://discord.com/users/528349333461008384"
							target="_blank"
							rel="noopener noreferrer"
							className="bg-stone-900 dark:bg-white p-2 text-white dark:text-stone-900 inline-flex items-center rounded-md hover:opacity-80 transition-opacity">
							<svg
						...
						<a 
							href="https://github.com/AchrafMez"
							target="_blank"
							rel="noopener noreferrer"
							className="bg-stone-900 dark:bg-white p-2 text-white dark:text-stone-900 inline-flex items-center rounded-md hover:opacity-80 transition-opacity">
							<svg
			...
			<p className="text-sm font-medium text-stone-900 dark:text-stone-300">
